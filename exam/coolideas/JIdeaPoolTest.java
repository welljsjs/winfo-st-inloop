...
public class JIdeaPoolTest {
        ...
        public void testAddJTopic() {
                ...
                ideaPool.add(i1, t1);
                ideaPool.add(t1);
                assertTrue("JIdeaPool.add(JTopic) should not remove any existing JIdea mappings in the pool!",
                                actPool.get(t1)
                                                .contains(i1));
        }
        ...
        public void testAddJIdeaJTopic() {
                ...
                assertTrue("JIdeaPool.add(JIdea, JTopic) should add the idea to the set of ideas of the given topic!",
                                actPool
        ...
        public void testRemoveJIdea() {
                ...
                assertTrue("JIdeaPool.remove(JIdea) should return true if the given idea exists in the pool and was removed!",
                                ideaPool.remove(i1));
                assertNull("JIdeaPool.remove(JIdea) should remove the idea from every topic!",
                                ideaPool.getIdea(i1.getTitle()));
                assertTrue("JIdeaPool.remove(JIdea) should return true if the given idea exists in the pool and was removed!",
                                ideaPool.remove(i3));
        ...
        public void testRemoveDeclined() {
                ...
                assertNull("JIdeaPool.removeDeclined() should remove all declined ideas!",
                                ideaPool.getIdea(i1.getTitle()));
                i2.decline();
                i3.decline();
                ideaPool.removeDeclined();
                assertNull("JIdeaPool.removeDeclined() should remove all declined ideas!",
                                ideaPool.getIdea(i2.getTitle()));
                assertNull("JIdeaPool.removeDeclined() should remove all declined ideas!",
                                ideaPool.getIdea(i3.getTitle()));
        }

...
public class VehicleGeneratorTest {
    ...
    public void testVehicleGenerator() {
        ...
        /*
         * This loop assumes that 100 random vehicles are enough to get each vehicle
         * type at least once. (The
         * probability that one of three vehicle types does not appear should be low
         * enough.)
         */
        for (int i = 0; i < 100; i++) {
